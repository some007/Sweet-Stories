...
public class MainBookAdpter extends RecyclerView.Adapter<MainBookAdpter.BookHolder> {
    private List<BookModel> books;
    private Context context;
    private OnItemClickListener<BookModel> modelListener;

    public MainBookAdpter(List<BookModel> books, Context context) {
        this.books = books;
